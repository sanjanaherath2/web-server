...
class WebServer(object):
    ...
    def __init__(self, port=5050):
        ...
        self.port = port
        self.content_dir = 'html' # Directory where webpage files are stored
            ...
            if request_method == "GET" or request_method == "HEAD":
                ...
                try:
                    ...
                    if request_method == "GET": # Temporary 404 Response Page
                        response_data = b"<html><body><center><h1>Error 404: File not found</h1></center><p>Head back to</p></body></html>"
